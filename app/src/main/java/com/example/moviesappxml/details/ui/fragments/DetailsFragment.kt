...
class DetailsFragment : Fragment() {
    ...
    private fun bindData(movie: MovieDetails) {
        ...
        with(binding.layoutMovieDetailsData) {
            ...
            Glide.with(requireContext()).load(movie.backdropUrl)
                .placeholder(R.drawable.placeholder_image).centerCrop().into(ivBackdrop)
            Glide.with(requireContext()).load(movie.posterUrl)
                .placeholder(R.drawable.placeholder_image).centerCrop().into(ivPoster)
        }
    }
